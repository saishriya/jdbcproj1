 ...
 * 
 */
@WebServiceClient(name = "HelloWorld_Service", targetNamespace = "http://codenotfound.com/services/helloworld", wsdlLocation = "file:/C:/Users/pondu/eclipse-workspace/top-down-web-service/src/main/resources/test.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Users/pondu/eclipse-workspace/top-down-web-service/src/main/resources/test.wsdl");
